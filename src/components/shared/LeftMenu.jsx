                    ...
                    <ul className="side-nav">
                      ...
                      <li className="side-nav-item">
                        ...
                        <div className="collapse" id="sidebarEcommerce">
                          <ul className="side-nav-second-level">
                            <li>
                              <Link to="apps-ecommerce-products.html">
                                Products
                              </Link>
                            </li>
                            <li>
                            ...
                            <li>
                              <Link to="apps-ecommerce-orders.html">
                                Orders
                              </Link>
                            </li>
                            <li>
                            ...
                            <li>
                              <Link to="apps-ecommerce-customers.html">
                                Customers
                              </Link>
                            </li>
                            <li>
                            ...
                            <li>
                              <Link to="apps-ecommerce-checkout.html">
                                Checkout
                              </Link>
                            </li>
                            <li>
                              <Link to="apps-ecommerce-sellers.html">
                                Sellers
                              </Link>
                            </li>
                          </ul>
                      ...
                      <li className="side-nav-item">
                        ...
                        <div className="collapse" id="sidebarProjects">
                          <ul className="side-nav-second-level">
                            ...
                            <li>
                              <Link to="apps-projects-details.html">
                                Details
                              </Link>
                            </li>
                            <li>
                      ...
                      <li className="side-nav-item">
                        ...
                        <div className="collapse" id="sidebarLayouts">
                          <ul className="side-nav-second-level">
                            <li>
                              <Link to="layouts-horizontal.html">
                                Horizontal
                              </Link>
                            </li>
                            <li>
                      ...
                      <li className="side-nav-title side-nav-item mt-1">
                        Components
                      </li>
                      <li className="side-nav-item">
                        <Link
                      ...
                      <li className="side-nav-item">
                        ...
                        <div className="collapse" id="sidebarExtendedUI">
                          <ul className="side-nav-second-level">
                            ...
                            <li>
                              <Link to="extended-scrollbar.html">
                                Scrollbar
                              </Link>
                            </li>
                            <li>
                              <Link to="extended-scrollspy.html">
                                Scrollspy
                              </Link>
                            </li>
                            <li>
                            ...
                            <li className="side-nav-item">
                              ...
                              <div className="collapse" id="sidebarApexCharts">
                                <ul className="side-nav-third-level">
                                  ...
                                  <li>
                                    <Link to="charts-apex-bubble.html">
                                      Bubble
                                    </Link>
                                  </li>
                                  <li>
                                  ...
                                  <li>
                                    <Link to="charts-apex-column.html">
                                      Column
                                    </Link>
                                  </li>
                                  <li>
                                    <Link to="charts-apex-heatmap.html">
                                      Heatmap
                                    </Link>
                                  </li>
                                  <li>
                                  ...
                                  <li>
                                    <Link to="charts-apex-mixed.html">
                                      Mixed
                                    </Link>
                                  </li>
                                  <li>
                                  ...
                                  <li>
                                    <Link to="charts-apex-radar.html">
                                      Radar
                                    </Link>
                                  </li>
                                  <li>
                                    <Link to="charts-apex-radialbar.html">
                                      RadialBar
                                    </Link>
                                  </li>
                                  <li>
                                    <Link to="charts-apex-scatter.html">
                                      Scatter
                                    </Link>
                                  </li>
                                  <li>
